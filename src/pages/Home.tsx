...
const Home: React.FC = () => {
    ...
    const tools = [
        {
            title: 'Resize & Preset',
            description: 'Scale images for your inventory. Optimized presets for t-shirts, mugs, and posters at 300 DPI.',
            icon: 'aspect_ratio',
        ...
        },
        {
            ...
            description: 'Transmute between modern formats. Bulk convert PNG, JPG, and WEBP files without losing durability.',
            icon: 'sync_alt',
