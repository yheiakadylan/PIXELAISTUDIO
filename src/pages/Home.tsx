...
const Home: React.FC = () => {
    ...
    const tools = [
        {
            title: 'Resize Image',
            description: 'Resize images by exact pixels or percentage. Maintain aspect ratio or set custom dimensions. Bulk resize with POD support.',
        ...
        },
        {
            ...
            description: 'Convert between PNG, JPG, WEBP, AVIF, BMP, GIF, ICO. Batch convert or set individual formats per image.',
            icon: 'sync_alt',
        ...
        },
        {
            ...
            description: 'Mining out the background automatically. Perfect for creating clean asset sprites and product shots.',
            icon: 'content_cut',
        ...
        {
            title: 'Upscale 4K',
            description: 'Enchant low-resolution blocks to crystal clear 4K quality using state-of-the-art super-resolution.',
            icon: 'bolt',
